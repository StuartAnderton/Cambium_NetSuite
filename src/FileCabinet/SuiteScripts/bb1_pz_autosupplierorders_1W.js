...
define(['N/http', 'N/https', 'N/ui/serverWidget', 'N/email', 'N/runtime', 'N/task', 'N/search','N/redirect','N/record','N/url'],
    ...
    function(http, https, serverWidget, email, runtime, task, search, redirect,record, url) {
        ...
        function onRequest(context) {
            ...
            var excludeOos = request.parameters.custpage_exclude_oos||'F'
            ...
            excludeOos = nextstep[4];
            log.debug('excldueOos', excludeOos)
            ...
            if (context.request.method === 'GET')
                ...
                createForm(form,supplierValue,buyerValue,sortItem,itemWithNoPrefVend_chk,itemVendorNotPreferred, available, excludeUts, excludeOos);
        ...
        function createForm(form, supplierValue, buyerValue, sortItem, itemWithNoPrefVend_chk,itemVendorNotPreferred, available, excludeUts, excludeOos){
            var relativePath ='';
            var output ='';
        ...
        if(supplierValue !=='')
            ...
            inc_prevendor.updateDisplayType({
                displayType: serverWidget.FieldDisplayType.HIDDEN
            });
        ...
        exc_prevendor.updateDisplayType({
                displayType: serverWidget.FieldDisplayType.HIDDEN
            });
            ...
            var is_available = form.addField({
                ...
                type: serverWidget.FieldType.CHECKBOX,
                label: 'Include only Available/TBD items'
            });

            is_available.updateDisplaySize({height: 60, width: 50});

            is_available.updateBreakType({
            ...
            var exclude_oos = form.addField({
                id: 'custpage_exclude_oos',
                type: serverWidget.FieldType.CHECKBOX,
                label: 'Exclude OOS items'
            });

            exclude_oos.updateDisplaySize({height: 60, width: 50});
            ...
            if(excludeOos === 'true')
                exclude_oos.defaultValue = 'T';
            else
                exclude_oos.defaultValue = 'F';
