    ...
    function (currentRecord, record, dialog, runtime, url) {
        ...
        function updateSublist(sublistAction) {
            ...
            for (var i = 0; i < count; i++) {
                ...
                var goodToGo = recordObj.getSublistValue({
                    sublistId: 'custpage_itemsublist',
                ...
                if (goodToGo === true) {
                    var jsonValue = recordObj.getSublistValue({
                        sublistId: 'custpage_itemsublist',
                        fieldId: 'custpage_json',
                        line: i
                    });
                    var hashValue = recordObj.getSublistValue({
                        sublistId: 'custpage_itemsublist',
                        fieldId: 'custpage_hash',
                        line: i
                    });
                    var supplierId = recordObj.getSublistValue({
                        sublistId: 'custpage_itemsublist',
                        fieldId: 'custpage_list_supplierid',
                        line: i
                    });
        ...
        function fieldChanged(scriptContext) {
            ...
            if (scriptContext.sublistId === 'custpage_itemsublist' && scriptContext.fieldId === 'custpage_mark') {
                ...
                var listItems = [];
                for (var i = 0; i < count; i++) {
                    var mark = scriptContext.currentRecord.getSublistValue({
                        sublistId: 'custpage_itemsublist',
                        fieldId: 'custpage_mark',
                        line: i
                    });
                    if (mark === true) {
                        ...
                        var jsonValue = scriptContext.currentRecord.getSublistValue({
                            sublistId: 'custpage_itemsublist',
                            fieldId: 'custpage_json',
                            line: i
                        });
                        var jsonHash = scriptContext.currentRecord.getSublistValue({
                            sublistId: 'custpage_itemsublist',
                            fieldId: 'custpage_hash',
                            line: i
                        });
            ...
            if (scriptContext.fieldId == 'custpage_clicksupplier') {
                ...
                for (var i = 0; i < lineCount; i++) {
                    var currentID = scriptContext.currentRecord.getSublistValue({
                        sublistId: 'custpage_itemsublist',
                        fieldId: 'custpage_list_supplierid',
                        line: i
                    });
                ...
                var currentJSON = scriptContext.currentRecord.getSublistValue({
                    sublistId: 'custpage_itemsublist',
                    fieldId: 'custpage_json',
                    line: i
                });
                ...
                var currentHASH = scriptContext.currentRecord.getSublistValue({
                    sublistId: 'custpage_itemsublist',
                    fieldId: 'custpage_hash',
                    line: i
                });
      ...
      */
            ...
            if ((fieldChangedId === 'custpage_supplier') || (fieldChangedId === 'custpage_buyer') || (fieldChangedId === 'custpage_sortpoitem') || (fieldChangedId === 'custpage_inc_prevendor') || (fieldChangedId === 'custpage_exclude_uts') || (fieldChangedId === 'custpage_is_available') || (fieldChangedId === 'custpage_exclude_oos') || (fieldChangedId === 'custpage_inc_excvendor')) {
                ...
                var custpage_exclude_oos = currentRecord.getValue({
                    fieldId: 'custpage_exclude_oos'
                });
                ...
                currentRecord.setValue({
                    ...
                    value: custpage_inc_prevendor + ':' + custpage_inc_excvendor + ':' + custpage_is_available + ':' + custpage_exclude_uts + ':' + custpage_exclude_oos,
                    ignoreFieldChange: false
                });
        ...
        function createPo(supplierID, json, hash) {
            ...
            window.open(output, '_blank', 'width=1200px,height=900px,resizable=yes,scrollbars=yes');
        }
