    ...
    function(http, https, serverWidget, email, runtime, task, search, redirect,record, url) {
        ...
        function onRequest(context) {
            ...
            if (context.request.method === 'GET')
                ...
                createForm(form,supplierValue,buyerValue,sortItem,itemWithNoPrefVend_chk,itemVendorNotPreferred);
        ...
        function createForm(form, supplierValue, buyerValue, sortItem, itemWithNoPrefVend_chk,itemVendorNotPreferred){
            var relativePath ='';
            var output ='';
            ...
            var buyer = form.addField({
                ...
                label: 'Buyer (All Prezola Buyer Employees)'
            });
